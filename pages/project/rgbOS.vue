<template>
   <div id='rgbOS'>
      <div class="jumbotron">
         ...
         <hr class="my-4">
         <p class="lead">I dette prosjektet prøve jeg på å lage et OS med ubuntu som kernel. 
            Gidde opp på hele prosjektet etter at jeg fant ut at det å lære Assembly ble for mye stress.
         </p>
      </div>
      <!--<ul class="rgbOS">
